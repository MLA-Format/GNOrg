    ...
    return (
        ...
        <div className="h-screen overflow-hidden flex flex-col" style={{ background: AUTH_GRADIENT }}>
            ...
            <div className="flex flex-1 min-h-0">
                ...
                {/* ── Right panel: fades into dark so gradient blends and text stays readable ── */}
                <div className="hidden lg:flex w-80 xl:w-96 shrink-0 flex-col border-l border-[#ffffff15] px-6 py-8 overflow-y-auto" style={{ background: 'linear-gradient(to right, transparent, #0a0f2e 35%)' }}>
                    {panel.type !== 'none' && (
